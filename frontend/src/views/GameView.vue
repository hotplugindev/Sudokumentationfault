      ...
      <div class="game-info">
        ...
        <div class="info-item">
          ...
          <span
            ...
            :class="{ 'text-error': game.mistakes > 0 }"
          >
            {{ game.mistakes }}
          </span>
        </div>
      ...
      <Transition name="fade">
        <div v-if="game.isFinished" class="game-result card">
          <template v-if="game.status === 'completed'">
            ...
            <div class="result-stats">
              <div class="result-stat">
                ...
                <span class="result-stat-value">{{ game.formattedTime }}</span>
              </div>
              <div class="result-stat">
                <span class="result-stat-label">Mistakes</span>
                <span class="result-stat-value">{{ game.mistakes }}</span>
              </div>
            </div>
          </template>
          ...
          <template v-else>
            ...
            <p class="result-sub">The solution has been revealed above.</p>
          </template>
